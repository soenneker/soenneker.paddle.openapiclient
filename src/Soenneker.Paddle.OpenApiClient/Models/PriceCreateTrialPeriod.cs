...
namespace Soenneker.Paddle.OpenApiClient.Models
{
    ...
    public partial class PriceCreateTrialPeriod : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateInterval? Interval { get; set; }
#nullable restore
#else
        public global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateInterval Interval { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateUnitPrice? UnitPrice { get; set; }
#nullable restore
#else
        public global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateUnitPrice UnitPrice { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Paddle.OpenApiClient.Models.PriceCreateTrialPeriod"/> and sets the default values.
        /// </summary>
        public PriceCreateTrialPeriod()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Paddle.OpenApiClient.Models.PriceCreateTrialPeriod"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Paddle.OpenApiClient.Models.PriceCreateTrialPeriod CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Paddle.OpenApiClient.Models.PriceCreateTrialPeriod();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "interval", n => { Interval = n.GetObjectValue<global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateInterval>(global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateInterval.CreateFromDiscriminatorValue); } },
                { "requires_payment_method", n => { RequiresPaymentMethod = n.GetBoolValue(); } },
                { "type", n => { Type = n.GetStringValue(); } },
                { "unit_price", n => { UnitPrice = n.GetObjectValue<global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateUnitPrice>(global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateUnitPrice.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateInterval>("interval", Interval);
            writer.WriteBoolValue("requires_payment_method", RequiresPaymentMethod);
            writer.WriteStringValue("type", Type);
            writer.WriteObjectValue<global::Soenneker.Paddle.OpenApiClient.Models.PriceTrialDurationCreateUnitPrice>("unit_price", UnitPrice);
