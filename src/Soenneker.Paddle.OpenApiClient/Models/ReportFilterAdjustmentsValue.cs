...
namespace Soenneker.Paddle.OpenApiClient.Models
{
    ...
    public partial class ReportFilterAdjustmentsValue : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Paddle.OpenApiClient.Models.ReportFilterAdjustmentsValue"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Paddle.OpenApiClient.Models.ReportFilterAdjustmentsValue CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var result = new global::Soenneker.Paddle.OpenApiClient.Models.ReportFilterAdjustmentsValue();
            ...
            else if(parseNode.GetStringValue() is string reportFilterAdjustmentsValueStringValue)
            {
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            else if(ReportFilterAdjustmentsValueString != null)
            {
