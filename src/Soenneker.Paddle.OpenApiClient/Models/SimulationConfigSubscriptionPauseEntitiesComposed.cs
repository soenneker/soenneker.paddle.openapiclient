...
namespace Soenneker.Paddle.OpenApiClient.Models
{
    ...
    public partial class SimulationConfigSubscriptionPauseEntitiesComposed : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        public SimulationConfigSubscriptionPauseEntitiesComposed()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Paddle.OpenApiClient.Models.SimulationConfigSubscriptionPauseEntitiesComposed"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Paddle.OpenApiClient.Models.SimulationConfigSubscriptionPauseEntitiesComposed CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Paddle.OpenApiClient.Models.SimulationConfigSubscriptionPauseEntitiesComposed();
        }
        /// <summary>
