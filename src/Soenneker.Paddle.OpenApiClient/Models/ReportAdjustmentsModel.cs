...
namespace Soenneker.Paddle.OpenApiClient.Models
{
    ...
    public partial class ReportAdjustmentsModel : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel.ReportAdjustmentsModel_rows? Rows { get; private set; }
#nullable restore
#else
        public global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel.ReportAdjustmentsModel_rows Rows { get; private set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "rows", n => { Rows = n.GetObjectValue<global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel.ReportAdjustmentsModel_rows>(global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel.ReportAdjustmentsModel_rows.CreateFromDiscriminatorValue); } },
        ...
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel_rowsMember1"/>, <see cref="int"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ReportAdjustmentsModel_rows : IComposedTypeWrapper, IParsable
        {
            /// <summary>Composed type representation for type <see cref="int"/></summary>
            public int? Integer { get; set; }
            /// <summary>Composed type representation for type <see cref="global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel_rowsMember1"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel_rowsMember1? ReportAdjustmentsModelRowsMember1 { get; set; }
#nullable restore
#else
            public global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel_rowsMember1 ReportAdjustmentsModelRowsMember1 { get; set; }
#endif
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel.ReportAdjustmentsModel_rows"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel.ReportAdjustmentsModel_rows CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel.ReportAdjustmentsModel_rows();
                if(parseNode.GetIntValue() is int integerValue)
                {
                    result.Integer = integerValue;
                }
                else {
                    result.ReportAdjustmentsModelRowsMember1 = new global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel_rowsMember1();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(ReportAdjustmentsModelRowsMember1 != null)
                {
                    return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(ReportAdjustmentsModelRowsMember1);
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(Integer != null)
                {
                    ...
                    writer.WriteObjectValue<global::Soenneker.Paddle.OpenApiClient.Models.ReportAdjustmentsModel_rowsMember1>(null, ReportAdjustmentsModelRowsMember1);
                }
            }
        }
    }
