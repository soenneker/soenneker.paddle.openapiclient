...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Paddle.OpenApiClient.Models.Transaction.Transaction_invoice_id? InvoiceId { get; private set; }
#nullable restore
#else
        public global::Soenneker.Paddle.OpenApiClient.Models.Transaction.Transaction_invoice_id InvoiceId { get; private set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "invoice_id", n => { InvoiceId = n.GetObjectValue<global::Soenneker.Paddle.OpenApiClient.Models.Transaction.Transaction_invoice_id>(global::Soenneker.Paddle.OpenApiClient.Models.Transaction.Transaction_invoice_id.CreateFromDiscriminatorValue); } },
        ...
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::Soenneker.Paddle.OpenApiClient.Models.Transaction_invoice_idMember1"/>, <see cref="string"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Transaction_invoice_id : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            public string String { get; set; }
#endif
            /// <summary>Composed type representation for type <see cref="global::Soenneker.Paddle.OpenApiClient.Models.Transaction_invoice_idMember1"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::Soenneker.Paddle.OpenApiClient.Models.Transaction_invoice_idMember1? TransactionInvoiceIdMember1 { get; set; }
#nullable restore
#else
            public global::Soenneker.Paddle.OpenApiClient.Models.Transaction_invoice_idMember1 TransactionInvoiceIdMember1 { get; set; }
#endif
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.Paddle.OpenApiClient.Models.Transaction.Transaction_invoice_id"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.Paddle.OpenApiClient.Models.Transaction.Transaction_invoice_id CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.Paddle.OpenApiClient.Models.Transaction.Transaction_invoice_id();
                if(parseNode.GetStringValue() is string stringValue)
                {
                    result.String = stringValue;
                }
                else {
                    result.TransactionInvoiceIdMember1 = new global::Soenneker.Paddle.OpenApiClient.Models.Transaction_invoice_idMember1();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(TransactionInvoiceIdMember1 != null)
                {
                    return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(TransactionInvoiceIdMember1);
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(String != null)
                {
                    ...
                    writer.WriteObjectValue<global::Soenneker.Paddle.OpenApiClient.Models.Transaction_invoice_idMember1>(null, TransactionInvoiceIdMember1);
                }
            }
        }
    }
